...
SECRET_KEY = 'django-insecure-efl2jq&pr$^@r&#0rfxu8bnogf-77&7s0+$9el+jx_m%aszbjz'
...
ROOT_URLCONF = 'Lillo_Vasquez_Pino.urls'
...
WSGI_APPLICATION = 'Lillo_Vasquez_Pino.wsgi.application'
